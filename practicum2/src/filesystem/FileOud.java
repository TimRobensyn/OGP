...
public class FileOud {
     ...
     */
	public FileOud(String name, int size, boolean writable) {
        setName(name);
        setSize(size);
        setWritable(writable);
    }
     ...
     */
    public boolean hasOverlappingUsePeriod(FileOud other) {
