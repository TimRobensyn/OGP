...
public class DeviceTest {
	...
	public void setUpFixture() {
		...
		System.out.println(Arrays.toString(ingredient1.getStandardTemperature()));
		System.out.println(Arrays.toString(ingredient1.getTemperature()));
...
//	}
	...
	public void testKettle_process() {
		...
		assertEquals(State.LIQUID, resultIngredient.getState());
